 ...
 */
public class TagDMQueryItem extends Structure {
	...
	public TagDMQueryItem() {
		super();
	}
	protected List<String> getFieldOrder() {
		return Arrays.asList("szDMCode", "szDMName", "ulDMType", "szOrgCode", "szOrgName", "ulDevaddrtype", "szDevAddr", "ulIsOnline", "ulDevExtStatus", "szReserve");
	}
	public TagDMQueryItem(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends TagDMQueryItem implements Structure.ByReference {
		
	};
	public static class ByValue extends TagDMQueryItem implements Structure.ByValue {
