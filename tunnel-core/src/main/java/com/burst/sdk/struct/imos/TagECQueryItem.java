 ...
 */
public class TagECQueryItem extends Structure {
	...
	public TagECQueryItem() {
		super();
	}
	protected List<String> getFieldOrder() {
		return Arrays.asList("szECCode", "szECName", "ulECType", "ulDevaddrtype", "szDevAddr", "szOrgCode", "ulIsOnline", "ulDevExtStatus", "ulIsMulticast", "ulEnableAlarm", "ulEncodeType", "ulStandard", "szReserve");
	}
	public TagECQueryItem(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends TagECQueryItem implements Structure.ByReference {
		
	};
	public static class ByValue extends TagECQueryItem implements Structure.ByValue {
