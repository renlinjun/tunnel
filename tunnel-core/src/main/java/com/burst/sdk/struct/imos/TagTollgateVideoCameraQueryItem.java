...
import static com.burst.sdk.constanst.IMOSDefLibrary.IMOS_MAX_CAMERA_LANE_NUM;
...
public class TagTollgateVideoCameraQueryItem extends Structure {
    ...
    protected List<String> getFieldOrder() {
        return Arrays.asList("szCameraCode","szCameraName","ulCameraType","szTollgateCode","szTollgateName","ulPhotoLaneNum","aulPhotoLaneList",
    ...
    public static class ByReference extends TagTollgateVideoCameraQueryItem implements Structure.ByReference {
        public ByReference() {}
    ...
    public static class ByValue extends TagTollgateVideoCameraQueryItem implements Structure.ByValue {
