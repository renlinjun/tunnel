 ...
 * @时间: 2019/3/6 15:59
 */
public class TagVehicleData_bak2 extends Structure {
    ...
    //public String  aszImgList = new byte[IMOS_MAX_VEHICLE_IMG_NUM * IMOS_MAX_VEHICLE_IMG_NAME_LEN];
    public String[]  aszImgList = new String[IMOSDefLibrary.IMOS_MAX_VEHICLE_IMG_NAME_LEN];
   ...
   //public String aszImgPathList = new byte[IMOS_MAX_VEHICLE_IMG_NUM * IMOS_MAX_VEHICLE_IMG_NAME_LEN];
   public String[] aszImgPathList = new String[IMOSDefLibrary.IMOS_MAX_VEHICLE_IMG_NAME_LEN];
    ...
    public TagVehicleData_bak2() {
        super();
    }

    public TagVehicleData_bak2(Pointer peer) {
        super(peer);
    }
    ...
    public static class ByReference extends TagVehicleData_bak2 implements Structure.ByReference {}
    public static class ByValue extends TagVehicleData_bak2 implements Structure.ByValue {}
}
