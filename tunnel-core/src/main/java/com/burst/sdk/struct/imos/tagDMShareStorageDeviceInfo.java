 ...
 */
public class tagDMShareStorageDeviceInfo extends Structure {
	...
	public tagDMShareStorageDeviceInfo() {
		super();
	}
	protected List<String> getFieldOrder() {
		return Arrays.asList("szStoreDevCode", "szStoreDevName", "ulTotalShareCapacity", "ulStorageHours", "szReserve");
	}
	/**
	 ...
	 */
	public tagDMShareStorageDeviceInfo(byte szStoreDevCode[], byte szStoreDevName[], int ulTotalShareCapacity, int ulStorageHours, byte szReserve[]) {
		super();
	...
	public tagDMShareStorageDeviceInfo(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends tagDMShareStorageDeviceInfo implements Structure.ByReference {
		
	};
	public static class ByValue extends tagDMShareStorageDeviceInfo implements Structure.ByValue {
