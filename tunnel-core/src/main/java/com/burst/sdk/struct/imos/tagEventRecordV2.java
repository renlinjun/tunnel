 ...
 */
public class tagEventRecordV2 extends Structure {
	...
	/** C type : CHAR[IMOS_NAME_LEN] */
	public byte[] szParentDevName = new byte[IMOSDefLibrary.IMOS_NAME_LEN];
	/** C type : CHAR[IMOS_NAME_LEN] */
	...
	public tagEventRecordV2() {
		super();
	}
	protected List<String> getFieldOrder() {
		return Arrays.asList("szEventRecordCode", "ulEventType", "szDeviceCode", "szDeviceName", "szParentDevName", "szActiveName", "ulEventSecurity", "szEventTime", "ulAlarmStatus", "szSecurityName", "szSecurityColor", "szCheckTime", "szCheckUser", "szAckTime", "szAckUser", "szKeyValue", "szEventDesc", "szAckSuggestion", "ulIsMisinform", "ulIsPlanAlarm", "ulIsOncePlanAlarm", "ulIsManualTask", "szReserve");
	}
	public tagEventRecordV2(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends tagEventRecordV2 implements Structure.ByReference {
		
	};
	public static class ByValue extends tagEventRecordV2 implements Structure.ByValue {
