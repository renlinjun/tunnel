 ...
 */
public class tagTimeSliceForResV2 extends Structure {
	 ...
	 */
	public tagTimeSliceForResV2(byte szResCode[], byte szResName[], tagTimeSlice stTimeSlice) {
		super();
	...
	public tagTimeSliceForResV2(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends tagTimeSliceForResV2 implements Structure.ByReference {
		
	};
	public static class ByValue extends tagTimeSliceForResV2 implements Structure.ByValue {
