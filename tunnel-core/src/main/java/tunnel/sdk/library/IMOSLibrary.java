...
public interface IMOSLibrary extends StdCallLibrary {
     ...
     * 返回操作结果码，见错误码文件
     */
    int IMOS_QueryTollgate(TagUserLoginIDInfo.ByReference userLoginIDInfo, byte[] szTollgateCode, TagTollgateInfo tagTollgateInfo);
     ...
     * @note 无。
     */
    int IMOS_GetChannelCode(TagUserLoginIDInfo.ByReference userLoginIdInfo, String pcChannelCode);
