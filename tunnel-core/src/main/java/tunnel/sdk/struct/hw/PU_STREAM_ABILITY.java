 ...
 */
public class PU_STREAM_ABILITY extends Structure {
	...
	/** C type : PU_STREAM_ABILITY_PARA_S[4] */
	public PU_STREAM_ABILITY_PARA[] stStreamAbility = new PU_STREAM_ABILITY_PARA[4];
	/** C type : CHAR[32] */
	...
	public PU_STREAM_ABILITY(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends PU_STREAM_ABILITY implements Structure.ByReference {
		
	};
	public static class ByValue extends PU_STREAM_ABILITY implements Structure.ByValue {
