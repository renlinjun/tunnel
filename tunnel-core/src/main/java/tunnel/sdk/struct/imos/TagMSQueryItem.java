 ...
 */
public class TagMSQueryItem extends Structure {
	...
	public TagMSQueryItem() {
		super();
	}
	protected List<String> getFieldOrder() {
		return Arrays.asList("szMSCode", "szMSName", "szOrgCode", "szOrgName", "ulDevaddrtype", "szDevAddr", "ulIsOnline", "ulDevExtStatus");
	}
	/**
	 ...
	 */
	public TagMSQueryItem(byte szMSCode[], byte szMSName[], byte szOrgCode[], byte szOrgName[], int ulDevaddrtype, byte szDevAddr[], int ulIsOnline, int ulDevExtStatus) {
		super();
	...
	public TagMSQueryItem(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends TagMSQueryItem implements Structure.ByReference {
		
	};
	public static class ByValue extends TagMSQueryItem implements Structure.ByValue {
