 ...
 */
public class tagShareTollgateInfo extends Structure {
	/** C type : int */
	...
	public tagShareTollgateInfo() {
		super();
	}
	protected List<String> getFieldOrder() {
		return Arrays.asList("ulTollgateType", "szTollgateCode", "szTollgateName", "szTollgateShareCode", "szParOrgCode");
	}
	/**
	 ...
	 */
	public tagShareTollgateInfo(int ulTollgateType, byte szTollgateCode[], byte szTollgateName[], byte szTollgateShareCode[], byte szParOrgCode[]) {
		super();
	...
	public tagShareTollgateInfo(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends tagShareTollgateInfo implements Structure.ByReference {
		
	};
	public static class ByValue extends tagShareTollgateInfo implements Structure.ByValue {
