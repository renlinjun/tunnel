 ...
 */
public class tagStorePlanBase extends Structure {
	...
	public tagStorePlanBase() {
		super();
	}
	protected List<String> getFieldOrder() {
		return Arrays.asList("szStorePlanName", "szPlanCreateTime", "ulPlanType", "szOrgCode", "szPlanDesc", "bIsDayStore", "ulStoreDays");
	}
	/**
	 ...
	 * @param ulStoreDays C type : int
	 */
	public tagStorePlanBase(byte szStorePlanName[], byte szPlanCreateTime[], int ulPlanType, byte szOrgCode[], byte szPlanDesc[], int bIsDayStore, int ulStoreDays) {
		super();
	...
	public tagStorePlanBase(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends tagStorePlanBase implements Structure.ByReference {
		
	};
	public static class ByValue extends tagStorePlanBase implements Structure.ByValue {
