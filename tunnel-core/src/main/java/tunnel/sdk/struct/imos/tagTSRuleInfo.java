 ...
 */
public class tagTSRuleInfo extends Structure {
	 ...
	 */
	public tagTSRuleInfo(byte szRuleName[], byte szRuleCode[], int bIsEnable, int ulStreamType, int ulTransType, byte szReserved[]) {
		super();
	...
	public tagTSRuleInfo(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends tagTSRuleInfo implements Structure.ByReference {
		
	};
	public static class ByValue extends tagTSRuleInfo implements Structure.ByValue {
