...
public class VehicleData {
    ...
    /** 是否属于两客一危车辆 */
    private boolean isPassengerDanger;
    ...
    public void setInSideOrOutSide(int inSideOrOutSide) {
        this.inSideOrOutSide = inSideOrOutSide;
    }

    public boolean isPassengerDanger() {
        return isPassengerDanger;
    }

    public void setPassengerDanger(boolean passengerDanger) {
        isPassengerDanger = passengerDanger;
    }
}
